...
import { getSidebarSize } from "src/app/pages/store/layouts/layout-selector";
...
export class VerticalComponent implements OnInit {
    ...
    if (document.documentElement.getAttribute("data-sidebar-size") == "lg") {
      ...
      window.addEventListener("resize", () => {
        ...
        if (document.documentElement.clientWidth <= 767) {
          ...
          if (
            document.documentElement.getAttribute("data-layout-width") ==
            "fluid"
          ) {
  ...
  private handlePreloader(route: any) {
    let htmlElement = document.getElementById("preloader") as HTMLElement;
    if (route !== "/disabled-route" && htmlElement && htmlElement.style) {
    ...
    } else if (htmlElement && htmlElement.style) {
      htmlElement.style.opacity = "0";
      htmlElement.style.visibility = "hidden";
    }
  }
